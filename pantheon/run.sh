...
docker run --mount "type=bind,source=${DIR},target=/pantheon" -p 8545:8545 -p 8546:8546 --network="beacontest" --name="eth1" pegasyseng/pantheon:1.2.0 --genesis-file=/pantheon/eth1-genesis.json --data-path=/pantheon/data --host-whitelist="*" \
